...
This repository contains all the code used to generate the animations for the video ["Contrastive Learning with SimCLR"](https://youtu.be/UqJauYELn6c) on the youtube channel [Deepia](https://www.youtube.com/@Deepia-ls2fo).
